...
//     return (
//         <div ref={container} className="flex items-center justify-center ">
//             <motion.div
//                 style={{
//                     scale,
...
//                 >
//                     <h2 className="text-2xl md:text-3xl font-semibold bg-gradient-to-r from-[#F9D000] to-[#F2AA00] bg-clip-text text-transparent">
//                         {title}
//                     </h2>
